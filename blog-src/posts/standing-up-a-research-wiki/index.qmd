...
- [Muscle memory is not knowledge](../muscle-memory-is-not-knowledge/), the motivation: the model brings the capability, standing up the wiki is how you supply the knowledge.
