...
- [Federated architecture (GeeksforGeeks)](https://www.geeksforgeeks.org/system-design/federated-architecture-system-design/), federation in the general sense.
- [Agent2Agent (A2A) protocol (IBM)](https://www.ibm.com/think/topics/agent2agent-protocol) and the [A2A protocol site](https://a2a-protocol.org/latest/), where "agent card" is defined.
