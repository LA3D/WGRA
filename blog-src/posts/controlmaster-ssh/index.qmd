...
- [OpenSSH Cookbook: Multiplexing (Wikibooks)](https://en.wikibooks.org/wiki/OpenSSH/Cookbook/Multiplexing) and [Using SSH multiplexing (Scott Lowe)](https://blog.scottlowe.org/2015/12/11/using-ssh-multiplexing/), what ControlMaster is and why (speed).
- [CyberArk Secretless Broker](https://github.com/cyberark/secretless-broker), the credential-broker pattern with tooling.
