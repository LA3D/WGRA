...
The architecture map in this post is drawn from James Sweet's internal talk *Where Harnesses Overlap*. The measurements are from the WGRA read-path experiments. Putting the two together answers a practical question our team keeps hitting: **if you switch the agent harness, say from Claude Code to Codex, do you lose anything, and can you get it back?**
...
*Architecture map: James Sweet, "Where Harnesses Overlap." Measurements: the WGRA read-path experiments, common GPT-4.1 judge, on a synthetic 40-question wiki.*
