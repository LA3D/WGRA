...
4. Variance cascade *(forthcoming)*. How uncertainty compounds through a chain of agents.
...
None of that is philosophical. Here is a concrete case from a project I lead. We ran four versions of a knowledge-graph extraction pipeline over the same scanned documents and counted the relationships each produced, five runs per version:
...
*I wrote this, and I am the PI on the project it draws from; the examples come from work with Priscila Moreira, Andrey Kuehlkamp, and James Sweet. The Software 2.0 framing is Andrej Karpathy's; Software 2.5 is our extension of it.*
