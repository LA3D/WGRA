...
::: {.column width="42%"}
The **WGRA Nuggets** blog collects the ideas behind this work as short, self-contained posts you can graze in any order, across evidence, foundations, retrieval, graph, and practice.

Start anywhere; the lineage traces back to Karpathy's llm-wiki.
...
[Talks, deep dives, and the paper]{.kicker}

This talk sits alongside two others and a set of written deep dives, all linked from the site:

- **Agentic research workflows** (this talk) — using Codex to start a project knowledge base.
- **Research memory that compounds** — extracting sources into a durable, queryable llm-wiki.
- **Knowledge: Extract, Retrieve, Synthesize** — the extract, retrieve, synthesize flow and the knowledge graph.

::: {.callout-highlight}
Everything lives at `la3d.github.io/WGRA`: the landing page, the Nuggets blog, the deep dives, and the paper *Beyond Memory* (Saboia Moreira et al., 2026).
:::
