...
## Behavioral salience and reducible entropy {.smaller}

[The transcript is a saliency map; the loop reduces the uncertainty it can, ground-truth-free by construction]{.kicker}
...
.reveal .esl-box{margin-top:-0.5em;}
</style>
...
The loop: flag high entropy from the transcript, attempt reduction by zoom and re-extract, confirm the drop ground-truth-free, and loop.
:::
